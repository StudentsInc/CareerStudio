  ...
  return (
    <div className="join_info relative odd:ms-auto odd:self-end odd:mb-[100px]">
      <div className={`w-fit text-end`}>
        ...
        {props.id == 1 && (
          <div className='wavy-line after:w-[750.163px] after:h-[930px] after:bg-contain  lg:after:absolute lg:after:content-[""] after:bg-[url("/src/assets/images/homePage/wavy/wavyLine.png")] after:left-[50px] after:top-[35px] after:bg-no-repeat after:bg-cover'></div>
        )}
      </div>
    </div>
  );
